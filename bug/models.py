...
class Bug(models.Model):
    ...
    bugdetail = models.CharField(verbose_name='详情',max_length=200)
    ...
    buglevel=models.CharField(verbose_name='严重程度',choices=BUG_LEVEL,default='3',max_length=20,null=True)

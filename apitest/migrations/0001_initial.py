# Generated by Django 2.0 on 2020-10-22 11:12
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('apimethod', models.CharField(choices=[('get', 'get'), ('post', 'post'), ('put', 'put'), ('delete', 'delete'), ('patch', 'patch')], default='get', max_length=20, null=True, verbose_name='请求方法')),
                ('apiresult', models.CharField(max_length=200, verbose_name='预期结果')),
                ('apistatus', models.BooleanField(verbose_name='是否通过')),
                ('apistep', models.CharField(max_length=100, verbose_name='测试步骤')),
                ('apiresponse', models.CharField(max_length=5000, verbose_name='返回结果')),
